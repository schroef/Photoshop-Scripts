...
function settingDialog(exportInfo) {
    ...
    dlgMain.cbTrimLayers = dlgMain.grICCGr.add('checkbox', undefined, strCheckboxTrimLayers);
    dlgMain.cbTrimLayers.value = exportInfo.convicc;
    // dlgMain.cbTrimLayers.alignment = 'right';
    dlgMain.cbTrimLayers.helpTip = strCheckboxTrimLayersHelp;
    ...
    exportInfo.trimLayers = dlgMain.cbTrimLayers.value;
