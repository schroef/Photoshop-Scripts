...
var strCheckboxAddCompComment = localize("$$$/JavaScripts/LayerCompsToABFiles/AddCompComment=&Inlcude Layer Comp Comment");
...
function exportArtboards(compsIndex, artbrdIndex, exportInfo, abAr, compRef, nameCountObj) {
    ...
    if ((null != compRef.comment) && exportInfo.addCompComment) {
        ...
        if (fileNameBody.length > 20) fileNameBody = fileNameBody.substring(0, 20);
    }
